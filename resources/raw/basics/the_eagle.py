...
def agent(obs, config):
    ...
    for shipyard in me.shipyards:
        ...
        action = box_miner(turn)

        if len(me.fleet_ids) >20:
            if action == None:
                if shipyard.ship_count >= 100 and turn % 7 == 0 and turn % 100 > 20 and turn % 100 < 90:
                ...
                if kore_left >= 500 and shipyard.ship_count >= convert_cost*2:
